...
%I checked solution with no rotational inertia 
%when solution is checked with no rotational intertia, this derivation 
% matches Eq 5 from Zhidi's report (expect for inverting all of the signs)
...
R = [  0        0           1;
 ...
 Hdot_relG = I_Beta* omega_dot_Beta_inBeta...
           + cross(omega_Beta_inBeta, I_Beta* omega_Beta_inBeta);
       
 Hdot_GrelCprime = cross(r_GrelC, m*a_G);
 
 Hdot_relCprime = Hdot_GrelCprime + Hdot_relG;
